...
public class ProductResourceTest {
	...
	public void setup() throws Exception {
		...
		details.add(ProductDetail.builder().description("teste").build());
		mockProduct.setDetails(details);

		when(service.search(any())).thenReturn(Arrays.asList(mockProduct));
		when(service.create(any(Product.class))).thenReturn(mockProduct);
		when(service.retrieve(anyLong())).thenReturn(mockProduct);
		when(service.update(anyLong(), any(Product.class))).thenReturn(mockProduct);
		doAnswer((i) -> {
	...
	public void testSearchProductsWithKeyword() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/products?keyword=gramp")
	...
	public void testCreate() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/products").accept(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsBytes(mockProduct)).contentType(MediaType.APPLICATION_JSON);
		...
		assertEquals("http://localhost/products/9999", response.getHeader(HttpHeaders.LOCATION));

	}

	@Test
	public void testRetrieve() throws Exception {
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/products/9999").accept(MediaType.APPLICATION_JSON)
	...
	public void testUpdate() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.put("/products/9999").accept(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsBytes(product)).contentType(MediaType.APPLICATION_JSON);
	...
	public void testDelete() throws Exception {
		RequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/products/9999")
